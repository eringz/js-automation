...
console.log("Task 2\n");
/**
 * Convert given Strings below to number data types and find the greatest and smalles values and find the average and absolute difference of them.
 * let s1 = "200", s2 = "-50";
 * Expected results:
 ...
 * Test Data:
    5, 27
 * Expected Output:
    The aboslute difference between number is = 22
 */
